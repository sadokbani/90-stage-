...
@NgModule({
  ...
  declarations: [DashboardComponent, UsersComponent, ClientComponent,
    CommercantComponent, ArchiveComponent, CategorieComponent, CreateCategorieComponent,
    UpdateCategorieComponent, SouscategorieComponent, CreateSouscategorieComponent, UpdateSouscategorieComponent, ArchiveCategorieComponent, ArchiveSouscategorieComponent]
})
